...
class SRCNN_net(torch.nn.Module):
    def __init__(self, num_channels, f1=9, f2=1, f3=5):
        ...
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=f2, stride=1, padding=0, bias=True)
        self.conv3 = nn.Conv2d(in_channels=32, out_channels=1, kernel_size=f3, stride=1, padding=0, bias=True)
